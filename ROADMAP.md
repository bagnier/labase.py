...
- [x] migrate context-owned dependencies from `shared/dependencies.py` into their respective `contract/` (e.g. `CurrentOrg` → `organizations/contract/`, `get_current_user` → `auth/contract/`)
