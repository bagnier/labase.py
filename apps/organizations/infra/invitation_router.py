...
from apps.shared.dto import Redirect
...
@router.get("/{token}", responses=json_and_html(InvitationRead))
...
@router.post("/{token}/accept", status_code=status.HTTP_200_OK, response_model=Redirect)
